  ...
  <div>
    ...
    <ul>
      ...
      <li>
        ...
        <a href="mailto:itayadler13@gmail.com" target="_blank">itayadler13@gmail.com</a>
      </li>
      <li>
        <i class="fa fa-linkedin fa-lg fa-fw" style="vertical-align: -5%;"></i>
        <a href="https://www.linkedin.com/in/itay-adler-489b181b6/" target="_blank">linkedin.com/itayadler</a>
      </li>
      <li>
        <i class="fa fa-github fa-lg fa-fw"></i>
        <a href="https://github.com/itayweb" target="_blank">github.com/itayweb</a>
      </li>
      <li>
